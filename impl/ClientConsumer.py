...
class AsyncConsumer(object):
    ...
    def __init__(self, amqp_url, exchange, exchange_type, queue, prefetch_count=1, durable=True):
    ...
    def setup_queue(self, queue_name):
        ...
        self._channel.queue_declare(
            queue=queue_name, durable=self.durable, callback=cb)
    ...
    def publish_message(self, exchange, queue, properties, message):
        ...
        if self._channel is None or not self._channel.is_open:
            return
        self._channel.basic_publish(exchange, queue,
                                    message,
                                    properties)
